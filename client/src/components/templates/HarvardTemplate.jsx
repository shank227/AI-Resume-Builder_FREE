...
export default function HarvardTemplate({ data, accentColor = "#111827" }) {
  ...
  return (
    ...
    >
      ...
      {data.summary && (
        <section className="mb-5">
          <h2 className="font-semibold text-[14px] mb-1" style={{ color: accentColor }}>
            SUMMARY
          </h2>
          <div
      ...
      {data.education?.length > 0 && (
        <section className="mb-5">
          <h2 className="font-semibold text-[14px] mb-2" style={{ color: accentColor }}>
            EDUCATION
          </h2>
      ...
      {data.skills?.length > 0 && (
        <section>
          ...
          <div className="flex flex-wrap gap-2">
            {data.skills.map((skill, idx) => (
              <span key={idx} className="px-2 py-1 bg-gray-100 rounded text-[12px]">
                {skill}
              </span>
            ))}
          </div>
