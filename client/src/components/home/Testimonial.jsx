...
const Testimonial = () => {
    ...
    return (
        <div id='testimonial' className="flex flex-col items-center px-6 md:px-16 lg:px-24 pt-20 pb-30">
            <div className="flex flex-col justify-center items-center text-center">
                ...
                <h1 className="text-4xl md:text-[40px] font-bold">Don't just take our words</h1>
